...
* https://blog.csdn.net/qq_24433609/article/details/127325267
...
在前面的介绍中, 我们知道 Go module 的 go.mod 中记录的 module 名字决定了 import 路径. 例如, 要引用 module github.com/renhongcai/indirect 中的内容时, 其 import 路径需要为 import github.com/renhongcai/indirect.
